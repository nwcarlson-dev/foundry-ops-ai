...
import { AppFrame, Panel, PageNote, PROSE } from '../shell';
...
export default function ToolsPage() {
    return (
        <AppFrame meta={`${TOOLS.length} tools · one definition`}>
            <p className={`${PROSE} mb-5 text-[0.95rem] leading-relaxed text-ink-300`}>
...
{`            lib/tools/  ·  ${TOOLS.length} typed, read-only, parameterised SQL
   ...
   this website     Claude Desktop   your client       CI`}
                    ...
                    <p className={`${PROSE} mt-3 font-mono text-[0.68rem] leading-relaxed text-ink-500`}>
                        ...
                        {TOOLS.map((tool) => {
                            ...
                            return (
                                <div key={tool.name} className="px-4 py-3">
                                    ...
                                    <p className={`${PROSE} mt-1.5 text-[0.82rem] leading-relaxed text-ink-300`}>
                                        {tool.description}
                                    </p>
